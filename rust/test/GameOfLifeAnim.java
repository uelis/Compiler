// Conway' Game of Life with animation on ANSI terminal
    ...
    public int calc(Board pred) {
        ...
        while (y < height) {
            ...
            while (x < width) {
                ...
                count = pred.at(x - 1, y - 1) + pred.at(x, y - 1) + pred.at(x + 1, y - 1) + pred.at(x - 1, y)
                        + pred.at(x + 1, y) + pred.at(x - 1, y + 1) + pred.at(x, y + 1) + pred.at(x + 1, y + 1);
